...
public class Main3Activity extends AppCompatActivity implements View.OnClickListener, OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newvalue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addEntry((float) hexStringToFloat(f[0]), (float) hexStringToFloat(f[1]), (float) hexStringToFloat(f[2]), (float) hexStringToFloat(f[3]), (float) hexStringToFloat(f[4]), (float) hexStringToFloat(f[5]));
                addEntry2((float) hexStringToFloat(f[6]), (float) hexStringToFloat(f[7]), (float) hexStringToFloat(f[8]), (float) hexStringToFloat(f[9]), (float) hexStringToFloat(f[10]), (float) hexStringToFloat(f[11]));
    ...
    private void addEntry(float xValue, float yValue, float zValue, float aValue, float bValue, float cValue) {
        ...
        if (chart.getData() != null &&
            ...
            y.setColor(Color.rgb(255, 102, 102));
            y.setCircleColor(Color.TRANSPARENT);
            y.setLineWidth(2f);
            y.setCircleRadius(3f);
            y.setFillAlpha(65);
            y.setFillColor(Color.rgb(255, 102, 102));
    ...
    private void addEntry2(float xValue, float yValue, float zValue, float aValue, float bValue, float cValue) {
        ...
        if (chart2.getData() != null &&
            ...
            z.setDrawCircleHole(false);
            z.setHighLightColor(Color.rgb(244, 117, 117));
            a = new LineDataSet(values4, "gyr_y_L");
            a.setAxisDependency(YAxis.AxisDependency.RIGHT);
            a.setColor(Color.rgb(51, 204, 255));
            a.setCircleColor(Color.TRANSPARENT);
            a.setLineWidth(2f);
            ...
            b = new LineDataSet(values5, "gyr_z_H");
            b.setAxisDependency(YAxis.AxisDependency.RIGHT);
            b.setColor(Color.rgb(0, 102, 0));
            b.setCircleColor(Color.TRANSPARENT);
            b.setLineWidth(2f);
            ...
            b.setDrawCircleHole(false);
            b.setHighLightColor(Color.rgb(244, 117, 117));
            c = new LineDataSet(values6, "gyr_z_L");
            c.setAxisDependency(YAxis.AxisDependency.RIGHT);
            c.setColor(Color.rgb(102, 255, 102));
            c.setCircleColor(Color.TRANSPARENT);
            c.setLineWidth(2f);
...
//            randomStringBuilder.append(String.valueOf(new Random().nextInt((max - min) + 1) + min));
            String generatedValue = Integer.toHexString(r.nextInt(100));
            if (generatedValue.length() == 1) generatedValue = "0" + generatedValue;
            randomStringBuilder.append(generatedValue);
        }
        return randomStringBuilder.toString();
    }

    private static float hexStringToFloat(String value) {
        return (float)Integer.parseInt(value, 16);
    }
